...
.profile-header { background: linear-gradient(160deg, #5DBE9E 0%, #F0C060 50%, #3DA87E 100%); position: relative; overflow: hidden; }
.profile-header::after { content: ''; position: absolute; bottom: 0; left: 0; right: 0; height: 60rpx; background: #FAFCF9; border-radius: 28rpx 28rpx 0 0; }
...
.profile-avatar { width: 130rpx; height: 130rpx; border-radius: 50%; border: 3rpx solid rgba(255,252,247,0.5); box-shadow: 0 8rpx 32rpx rgba(44,62,51,0.15); }
...
.stat-card { flex: 1; background: #FFFFFF; border-radius: 20rpx; padding: 28rpx 8rpx 24rpx; text-align: center; box-shadow: 0 4rpx 24rpx rgba(44,62,51,0.06), 0 8rpx 48rpx rgba(44,62,51,0.035); margin: 0 6rpx; }
.stat-num { font-size: 44rpx; font-weight: 800; color: #5DBE9E; display: block; line-height: 1; }
.stat-label { font-size: 20rpx; color: #8FA89B; margin-top: 8rpx; letter-spacing: 3rpx; }

.menu-list { background: #FFFFFF; margin: 0 28rpx; border-radius: 20rpx; overflow: hidden; box-shadow: 0 2rpx 16rpx rgba(44,62,51,0.03); }
.menu-item { display: flex; align-items: center; padding: 32rpx 28rpx; border-bottom: 1rpx solid #EAEFEB; }
.menu-item:last-child { border-bottom: none; }
.menu-item__icon { font-size: 36rpx; margin-right: 20rpx; }
.menu-item__label { flex: 1; font-size: 28rpx; color: #2C3E33; font-weight: 500; }
.menu-item__badge { background: #5DBE9E; color: #FFF; font-size: 20rpx; padding: 4rpx 14rpx; border-radius: 9999rpx; margin-right: 12rpx; font-weight: 600; }
.menu-item__arrow { color: #8FA89B; font-size: 28rpx; }

.about-text { text-align: center; padding: 48rpx 0 80rpx; color: #8FA89B; font-size: 22rpx; letter-spacing: 2rpx; }
